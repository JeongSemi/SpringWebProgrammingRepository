            ...
            <section class="home-section home-full-height bg-dark bg-gradient" id="home" data-background="<%=application.getContextPath()%>/resources/images/rcmain_transparent.jpg">
                <div class="titan-caption">
                    <div class="caption-content">
                        ...
                        <button type="button" class="btn btn-border-w btn-round" data-toggle="modal" data-target="#registerModal">Setting</button>
                        <button type="button" class="btn btn-border-w btn-round" data-toggle="modal" data-target="#logoutModal">Logout</button>
                    </div>
                </div>
            </section>
            <!-- 이벤트등록 모달 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3 col-lg-3">
                                ...
                                <div class="alt-features-item">
                                    ...
                                    <h3 class="alt-features-title font-alt">Camera</h3>W : Up&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;X : Down</br>A : Left&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;D : Right</br>S : Center</br>
                                </div>
...
<%--         <script src="<%=application.getContextPath()%>/resources/js/database/eventtable.js"></script> --%>
